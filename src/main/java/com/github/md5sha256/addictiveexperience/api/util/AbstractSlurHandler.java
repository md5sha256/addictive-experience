...
public abstract class AbstractSlurHandler {
    ...
    protected AbstractSlurHandler(@NotNull Plugin plugin, long intervalTicks, @NotNull SlurEffectState slurEffectState) {
        this.slurEffectState = slurEffectState;
        this.task = Bukkit.getScheduler().runTaskTimer(plugin, this::updateState, intervalTicks, intervalTicks);
    }
